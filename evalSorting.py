...
arg_index_method_name =  'sorted-inv-index';


# =============================================================================

result_file_name    = './results/evalSortingIndex.res'
...
# =============================================================================
#
census_ds = dataset.DataSetCSV(description='Census data set A',
                                 access_mode='read',
                                 delimiter='\t',
                                 rec_ident='rec_id',
                                 header_line=False,
...
#
experiment_dict['census'] = ['Census', census_ds, census_ds,
                             census_rec_comp,
...
for (index_name, index_method) in ds_index_list:
    ...
    res_file_str = 'Dataset: %s, Method: %s, Description: %s, Num of Record Pairs: %d, RR: %.4f, Recall: %.4f, Precision: %.4f, Time Processing: %.4f' % \
                   (arg_data_set_name, index_name, index_method.description, num_rec_pairs, reduction_ratio * 100, recall * 100, precision * 100, time3-time1)
